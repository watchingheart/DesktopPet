...
class PetController: ObservableObject {
    ...
    init() {
        ...
        // 默认加载兔子 GIF
        let defaultGifPath = "/Users/jiangzg/workspace/ai-try/DesktopPet/tools/rabbit_output/兔_idle.gif"
        let gifURL = URL(fileURLWithPath: defaultGifPath)
...
class PetInteractionView: NSView {
    ...
    private func loadActionGIF(_ action: AnimationType) {
        ...
        let gifPath = "/Users/jiangzg/workspace/ai-try/DesktopPet/tools/rabbit_output/\(gifName)"
